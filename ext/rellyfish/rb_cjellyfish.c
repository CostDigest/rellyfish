...
void Init_rellyfish() {
    Rellyfish = rb_define_module("Rellyfish");
    rb_define_method(Rellyfish, "jaro_winkler", method_jaro_winkler, 3);
    rb_define_method(Rellyfish, "jaro_distance", method_jaro_distance, 2);
    rb_define_method(Rellyfish, "hamming_distance", method_hamming_distance, 2);
    rb_define_method(Rellyfish, "levenshtein_distance", method_levenshtein_distance, 2);
    rb_define_method(Rellyfish, "damerau_levenshtein_distance", method_damerau_levenshtein_distance, 2);
    rb_define_method(Rellyfish, "soundex", method_soundex, 1);
    rb_define_method(Rellyfish, "metaphone", method_metaphone, 1);
    rb_define_method(Rellyfish, "nysiis", method_nysiis, 1);
    rb_define_method(Rellyfish, "match_rating_codex", method_match_rating_codex, 1);
    rb_define_method(Rellyfish, "match_rating_comparison", method_match_rating_comparison, 2);
}
